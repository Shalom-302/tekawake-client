            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="bg-muted p-3 rounded-md">{currentDocument.name}</div>
                        </div>
                        ...
                        <div className="pt-4">
                            <Button
                                ...
                                onClick={() =>
                                    window.open(
                                        `/digital-signature/sign/document/${documentId}/download`,
                                        "_blank"
                                    )
                                }
                            >
                ...
                <div className="md:col-span-2 space-y-6">
                    {currentDocument.signatures && currentDocument.signatures.length > 0 ? (
                        <>
                            <Tabs
                                defaultValue={currentDocument.signatures[0].id}
                                onValueChange={value => setActiveSignatureId(value)}
                            >
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                {currentDocument.timestamps &&
                                currentDocument.timestamps.length > 0 ? (
                                    <div className="space-y-2">
