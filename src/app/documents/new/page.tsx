  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      if (!allowedTypes.includes(selectedFile.type)) {
        setUploadError('The file type is not supported. Please upload a PDF or Word document.');
        setFile(null);
        e.target.value = '';
        return;
      }
                    ...
                    <div className="space-y-2">
                      ...
                      <div 
                        className={`border-2 border-dashed rounded-md p-6 flex flex-col items-center justify-center cursor-pointer hover:bg-muted/50 transition-colors ${
                          file ? 'border-green-500 bg-green-50 dark:bg-green-950/20' : 'border-gray-300'
                        }`}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Contract of sale" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            A brief description to help signatories understand the document
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              <SelectItem value={SignatureType.STANDARD}>Standard (Basic)</SelectItem>
                              <SelectItem value={SignatureType.ADVANCED}>Advanced (With certificate)</SelectItem>
                              <SelectItem value={SignatureType.QUALIFIED}>Qualified (Legal value)</SelectItem>
                            </SelectContent>
                          </Select>
                          <FormDescription>
                            The level of security and legal validity of the signature
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                          ...
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="parallel">Parallel (All at the same time)</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormDescription>
                              How signatories will receive the requests
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              Duration before expiration of signature requests
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                        ...
                        {signatories.map((signatory, index) => (
                          <div key={index} className="border rounded-md p-4 space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="space-y-2">
                                <Label htmlFor={`signatory-email-${index}`}>Email</Label>
                                <Input 
                            ...
                            <div className="space-y-2">
                              ...
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="viewer">Viewer (no signature)</SelectItem>
                                </SelectContent>
                              </Select>
                            </div>
                          </div>
