            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
              <div className="flex-1">
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" onClick={clearFilters} disabled={!resourceFilter && !actionFilter && !searchQuery}>
                    Clear
                  </Button>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <p className="text-base">
                      {metrics?.last_event_timestamp 
                        ? formatDate(new Date(metrics.last_event_timestamp * 1000).toISOString())
                        : 'No event'}
                    </p>
                  </div>
                </div>
        ...
        <TabsContent value="dashboard">
          <Card className="p-6">
            <div className="text-center py-10">
              ...
              View trends and audit activity over time.
