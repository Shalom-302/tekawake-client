            ...
            <div className="grid gap-8">
                ...
                <section className="mt-8">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                        This example shows how the loading of analytics scripts depends on user
                        consent.
                    </p>
                </section>
                ...
                <section className="mt-8">
                    ...
                    <p className="mb-4">
                        A floating button appears to allow the user to modify their cookie
                        preferences after initial consent.
                    </p>
                    <div className="bg-gray-100 p-4 rounded-md mb-4">
                        <p className="text-sm">
                            Current floating button state:{" "}
                            <span className="font-semibold">
                                {showCookieBanner
                                    ? "Hidden (banner visible)"
                                    : "Visible (if consent given)"}
                            </span>
                        </p>
                    </div>
                    ...
                    <div className="relative border p-4 rounded-md h-36">
                        <p className="text-sm mb-4">
                            Preview of the button (normally floating in the bottom right-hand corner
                            of the screen) :
                        </p>
