      ...
      <div className="container mx-auto py-12 px-4 md:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            ...
            when you access the internet. Cookies are widely used by website owners in order to make 
          ...
          <p>
            We use cookies for a number of different purposes. Some cookies are necessary for technical 
            reasons; some enable a personalized experience for both visitors and registered users; 
            and some allow the display of advertising from selected third party networks. 
            Some of these cookies may be set when a page is loaded, or when a user takes a 
            particular action on the website. Many of the cookies we use are only set if you are a 
            registered user (so you don't need to register again when you visit 
            later), while others are set whenever you visit one of our websites, irrespective of whether 
            you have an account.
          </p>
          ...
          <p>
            These cookies help us understand how visitors interact with the website by collecting 
            and reporting information anonymously. They help us improve the site functionality and your experience.
          </p>
          ...
          <p>
            ...
            to prevent them from being placed. If you do this, however, you may have to manually 
            adjust some preferences every time you visit a site and some services and functionalities may not work.
          </p>
          
          <p>
            You can also adjust your cookie preferences at any time by clicking on the cookie preferences 
            button in the bottom right corner of the website.
          </p>
