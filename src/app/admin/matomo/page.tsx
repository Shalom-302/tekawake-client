                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input 
                      ...
                      onChange={(e) => setFormData({...formData, matomo_url: e.target.value})}
                    />
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      onChange={(e) => setFormData({...formData, site_id: parseInt(e.target.value) || 1})}
                    />
                    <p className="text-sm text-muted-foreground mt-1">
                      ID de votre site dans Matomo (généralement 1 pour le premier site)
                    </p>
                  </div>
                  
                  <div>
                    <Label htmlFor="heartbeat_timer">Intervalle de battement de cœur (secondes)</Label>
                    <Input 
                      id="heartbeat_timer" 
                      type="number" 
                      value={formData.heartbeat_timer}
                      onChange={(e) => setFormData({...formData, heartbeat_timer: parseInt(e.target.value) || 15})}
                    />
                    <p className="text-sm text-muted-foreground mt-1">
                      Fréquence d'envoi des pings pour le suivi du temps passé (0 pour désactiver)
                    </p>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch 
                      ...
                      onCheckedChange={(checked) => setFormData({...formData, track_admin_users: checked})}
                    />
                    <Label htmlFor="track_admin_users">Suivre les administrateurs</Label>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Ce code est automatiquement injecté dans votre application via le composant MatomoTracker.
                  </p>
...
<!-- End Matomo Code -->`}
                ...
                <div>
                  <h3 className="text-lg font-medium">Fonctions de suivi disponibles</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    Utilisez ces fonctions pour suivre des événements personnalisés dans votre application.
                  </p>
                  <pre className="p-4 bg-muted rounded-md text-xs overflow-auto">
                    {`// Suivre un événement
