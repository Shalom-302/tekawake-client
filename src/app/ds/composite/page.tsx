                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    The title of the savings group
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-border px-4 py-2 font-mono text-sm">
                            ...
                            <tr>
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Information about the group manager
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-border px-4 py-2 font-mono text-sm">
                            ...
                            <tr>
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Status of the group: not-started, in-progress, or completed
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-border px-4 py-2 font-mono text-sm">
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    The date when the group will start
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-border px-4 py-2 font-mono text-sm">
                            ...
                            <tr>
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Function called when the details button is clicked
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-border px-4 py-2 font-mono text-sm">
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Function called when the contribute/start button is clicked
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Visual variant: default, card, or outline
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-border px-4 py-2 font-mono text-sm">
                            ...
                            <tr>
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Function called when the add member button is clicked
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-border px-4 py-2 font-mono text-sm">
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Content to display when there are no members
                                </td>
                            </tr>
                            <tr>
                                <td className="border border-border px-4 py-2 font-mono text-sm">
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Maximum number of members to display before showing the show
                                    more button
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td className="border border-border px-4 py-2 text-sm">
                                    Function called when the show more button is clicked
                                </td>
                            </tr>
                        </tbody>
                    </table>
