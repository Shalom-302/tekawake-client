    ...
    >
      <ComponentSection title="Usage" id="usage">
        <p className="text-muted-foreground mb-4">
          The Group Card component is designed to display savings group information in a structured format, 
          including status indicators and action buttons.
        </p>
                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      <tr className="border-b">
                        ...
                        <td className="py-2 px-4 font-mono text-sm">required</td>
                        <td className="py-2 px-4">Title of the savings group</td>
                      </tr>
                      <tr className="border-b">
                        <td className="py-2 px-4 font-mono text-sm">manager</td>
                        <td className="py-2 px-4 font-mono text-sm">{"{ name: string, initials: string }"}</td>
                        <td className="py-2 px-4 font-mono text-sm">required</td>
                        <td className="py-2 px-4">Manager information for the group</td>
                      </tr>
                      <tr className="border-b">
                        <td className="py-2 px-4 font-mono text-sm">members</td>
                        <td className="py-2 px-4 font-mono text-sm">{"{ id: string, name: string, initials: string }[]"}</td>
                        <td className="py-2 px-4 font-mono text-sm">[]</td>
                        <td className="py-2 px-4">Array of members in the group</td>
                      </tr>
                      <tr className="border-b">
                        <td className="py-2 px-4 font-mono text-sm">onDetailsClick</td>
                        <td className="py-2 px-4 font-mono text-sm">{"() => void"}</td>
                        <td className="py-2 px-4 font-mono text-sm">required</td>
                        <td className="py-2 px-4">Handler called when the details button is clicked</td>
                      </tr>
                      <tr className="border-b">
                        <td className="py-2 px-4 font-mono text-sm">onContributeClick</td>
                        <td className="py-2 px-4 font-mono text-sm">{"() => void"}</td>
                        <td className="py-2 px-4 font-mono text-sm">required</td>
                        <td className="py-2 px-4">Handler called when the contribute button is clicked</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
