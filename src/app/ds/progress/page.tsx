            ...
            <div className="mb-10">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            The Progress component displays a visual indicator of completion status
...
<Progress value={45} />`}
            ...
            <div className="mb-10">
                ...
                <div className="p-4 border rounded-lg">
                    ...
                    <CodeBlock className="mt-2" code={`<Progress value={45} />`} />
                </div>
            </div>
                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr className="border-b">
                                ...
                                <td className="py-2 px-4">
                                    Whether to animate the progress indicator when value changes.
                                </td>
                            </tr>
                            <tr className="border-b">
