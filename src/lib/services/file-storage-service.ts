...
const fileStorageService = {
    ...
    async getProviders(): Promise<StorageProvider[]> {
        try {
            const response: AxiosResponse<StorageProvider[]> = await axiosClient.get(
                "/public/file-storage/providers"
            );
    ...
    async getProviderById(id: number): Promise<StorageProvider> {
        try {
            const response: AxiosResponse<StorageProvider> = await axiosClient.get(
                `/public/file-storage/providers/${id}`
            );
            return response.data;
        } catch (error) {
    ...
    async getDefaultProvider(): Promise<StorageProvider> {
        try {
            const response: AxiosResponse<StorageProvider> = await axiosClient.get(
                "/public/file-storage/providers/default"
            );
            return response.data;
        } catch (error) {
    ...
    async getFolders(parentId?: number): Promise<FileFolder[]> {
        try {
            ...
            const response: AxiosResponse<FileFolder[]> = await axiosClient.get(
                "/public/file-storage/folders",
                { params }
            );
            return response.data;
        } catch (error) {
    ...
    async createFolder(folderData: CreateFolderRequest): Promise<FileFolder> {
        try {
            const response: AxiosResponse<FileFolder> = await axiosClient.post(
                "/public/file-storage/folders",
                folderData
            );
            return response.data;
    ...
    async getFileById(id: number): Promise<StoredFile> {
        try {
            const response: AxiosResponse<StoredFile> = await axiosClient.get(
                `/public/file-storage/files/${id}`
            );
            return response.data;
        } catch (error) {
    ...
    async uploadFile(
        ...
        try {
            ...
            const response: AxiosResponse<FileUploadResponse> = await axiosClient.post(
                "/public/file-storage/files/upload",
                formData,
                config
            );
