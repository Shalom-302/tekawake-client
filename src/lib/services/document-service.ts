...
const DocumentService = {
    ...
    async getDocuments(): Promise<Document[]> {
        try {
            ...
            const response = await axiosClient.get<PaginatedResponse<WorkflowInstance>>(
                "/workflow/instances",
                {
                    params: {
    ...
    async getDocument(id: string): Promise<Document> {
        try {
            ...
            const workflowResponse = await axiosClient.get<WorkflowInstance>(
            ...
            try {
                const signatureResponse = await axiosClient.get(
                    `/digital-signature/sign/document/${workflowResponse.data.target_id}`
                );
                console.log("Document signature API response:", signatureResponse.data);
                signatureData = signatureResponse.data;
            } catch (signError) {
                console.warn(
                    "Could not fetch signature data, document may not be signed yet:",
                    signError
                );
            }
            ...
            return {
                ...
                status: mapWorkflowStateToDocumentStatus(
                    workflowResponse.data.current_state?.name || ""
                ),
                ...
                signatories:
                    (workflowResponse.data.metadata as DocumentMetadata)?.signatories || [],
            };
        } catch (error) {
    ...
    async createDocument(request: CreateDocumentRequest): Promise<DocumentCreateResponse> {
        try {
            ...
            const signResponse = await axiosClient.post(
            ...
            const workflowResponse = await axiosClient.post<WorkflowInstance>(
                "/workflow/instances",
                workflowData
            );
    ...
    async updateDocument(id: string, data: Partial<Document>): Promise<Document> {
        try {
            ...
            const workflowResponse = await axiosClient.patch(
                `/workflow/instances/${data.workflow_instance_id}`,
                workflowData
            );
    ...
    async downloadDocument(id: string): Promise<Blob> {
        try {
            ...
            const response = await axiosClient.get(
                `/digital-signature/sign/document/${id}/download`,
                {
                    responseType: "blob",
                }
            );
    ...
    async signDocument(
        ...
        try {
            ...
            const response = await axiosClient.post<Signature>(
                `/digital-signature/sign/document/${documentId}/signature`,
                signatureData
            );
            ...
            if (document.workflow_instance_id) {
                try {
                    ...
                    const transitionsResponse = await axiosClient.get<WorkflowTransition[]>(
                        `/workflow/instances/${document.workflow_instance_id}/transitions`
                    );
                    ...
                    if (signedTransition) {
                        ...
                        const transitionResponse = await axiosClient.post(
                            `/workflow/instances/${document.workflow_instance_id}/transition`,
                            {
    ...
    async addSignatory(
        ...
        try {
            ...
            await axiosClient.patch(
                `/workflow/instances/${document.workflow_instance_id}`,
                workflowData
            );
    ...
    async deleteDocument(id: string): Promise<void> {
        try {
            ...
            try {
                ...
                console.warn(
                    "Could not delete document from digital-signature service:",
                    deleteError
                );
            }
