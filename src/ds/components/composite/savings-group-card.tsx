...
const savingsGroupCardVariants = cva("w-full overflow-hidden", {
    variants: {
        variant: {
            default: "bg-card",
...
export interface SavingsGroupCardProps
        ...
        <Card className={cn(savingsGroupCardVariants({ variant, size }), className)} {...props}>
            <div className="p-6">
                    ...
                    {status === "not-started" && (
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-sm text-muted-foreground">
                                All members have not been identified yet.
                            </p>
                        </div>
                    )}
                </div>
                ...
                <div className="flex gap-3">
                    <Button variant="outline" className="flex-1" onClick={onDetailsClick}>
                        View Details
                    </Button>
                    {status !== "completed" && (
                        <Button variant="default" className="flex-1" onClick={onContributeClick}>
