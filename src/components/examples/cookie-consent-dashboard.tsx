...
export default function CookieConsentDashboard() {
    const { consent, consentGiven, acceptAll, rejectNonEssential, savePreferences, resetConsent } =
        useCookieConsent();
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white p-6 border rounded-lg shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    ...
                    <Button onClick={rejectNonEssential} variant="outline" className="w-full">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Ces cookies sont requis pour le fonctionnement de base du site
                                    web. Ils ne peuvent pas être désactivés.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Ces cookies permettent de mémoriser vos préférences afin de
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    ...
                                    interagissent avec le site web.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    ...
                                    sites web et afficher des publicités.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    {consentGiven && consent?.preferences && (
                        <div className="p-4 bg-green-50 border border-green-100 rounded-md">
                            ...
                            <p className="text-sm text-green-700">
                                Activés - Ces scripts sont chargés pour mémoriser vos préférences.
                            </p>
                        </div>
                    )}
                    ...
                    {consentGiven && consent?.statistics && (
                        <div className="p-4 bg-green-50 border border-green-100 rounded-md">
                            ...
                            <p className="text-sm text-green-700">
                                Activés - Google Analytics et autres outils de statistiques sont
                                chargés.
                            </p>
                        </div>
                    )}
                    ...
                    {consentGiven && consent?.marketing && (
                        <div className="p-4 bg-green-50 border border-green-100 rounded-md">
                            ...
                            <p className="text-sm text-green-700">
                                Activés - Pixels publicitaires et scripts de remarketing sont
                                chargés.
                            </p>
                        </div>
                    )}
                    ...
                    {(!consentGiven || !consent?.preferences) && (
                        <div className="p-4 bg-gray-50 border border-gray-100 rounded-md opacity-60">
                            ...
                            <p className="text-sm text-gray-500">
                                Désactivés - Vous n&apos;avez pas donné votre consentement.
                            </p>
                        </div>
                    )}
