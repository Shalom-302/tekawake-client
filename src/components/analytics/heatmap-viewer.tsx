          ...
          <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
            ...
            <PopoverContent className="w-80">
              <div className="grid gap-4">
                ...
                <Button onClick={() => { generateHeatmap(); setIsFilterOpen(false); }}>
                  Appliquer les filtres
                </Button>
              </div>
            </PopoverContent>
          </Popover>
          <Button variant="default" size="sm" onClick={generateHeatmap} disabled={loading}>
      ...
      <CardContent>
        {loading ? (
          <div className="flex flex-col items-center justify-center h-64">
            ...
            <p className="text-sm text-muted-foreground">Génération de la heatmap en cours...</p>
          </div>
        ) : error ? (
          <div className="flex flex-col items-center justify-center h-64">
          ...
          <div>
            <div className="relative w-full overflow-hidden rounded-lg border">
              ...
              <div className="bg-background h-96 w-full flex items-center justify-center">
                {filter.page_path ? (
                  <p className="text-sm text-muted-foreground">Page: {filter.page_path}</p>
                ) : (
                  <p className="text-sm text-muted-foreground">Toutes les pages</p>
                )}
              </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <div className="text-sm">
                <span className="font-medium">Événements</span>: {heatmapData.event_count}
              </div>
              <div className="text-sm">
