...
export default function MessageItem({
    ...
    const canEdit =
        isCurrentUser && message.message_type === MessageType.TEXT && !message.is_deleted;
    ...
    const renderStatusIcon = () => {
        ...
        const normalizedStatus =
            typeof message.status === "string" ? message.status.toLowerCase() : message.status;
        ...
        switch (normalizedStatus) {
            ...
            case "read":
                return (
                    <div className="flex items-center">
                        ...
                        <svg
                            className="-ml-3 w-4 h-4 text-white/60"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
            ...
            case "failed":
                return (
                    <div className="flex items-center">
                        <svg
                            className="w-3 h-3 text-red-500/60"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
    ...
    const renderMessageContent = () => {
        if (message.is_deleted) {
            return (
                <div className="italic text-gray-400 text-sm">This message has been deleted</div>
            );
        }
        ...
        switch (message.message_type) {
            ...
            case MessageType.IMAGE:
                return message.attachments && message.attachments.length > 0 ? (
                    <div className="relative rounded overflow-hidden max-w-xs">
                        ...
                        />
                        {message.content && <div className="mt-1 text-sm">{message.content}</div>}
                    </div>
                ) : null;
            ...
            default:
                return message.content ? (
                    ...
                    <div className="italic text-gray-400">[Encrypted message]</div>
                );
        }
    };
