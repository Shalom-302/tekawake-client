...
export default function MessageList({ currentUserId }: MessageListProps) {
    ...
    useEffect(() => {
        ...
        const refreshConversation = () => {
            ...
            setTimeout(() => {
                ...
                console.log(
                    "Forcing message list refresh for conversation:",
        ...
        const handleNewMessage = (event: Event) => {
            ...
            if (customEvent.detail?.conversationId === activeConversation?.id) {
                console.log(
                    "New WebSocket message for this conversation:",
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div ref={messageListRef} className="flex-1 px-4 py-2" onScroll={handleScroll}>
