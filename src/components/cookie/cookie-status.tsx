    ...
    if (!consentGiven || !consent) {
        return (
            <div className={`p-4 border rounded-md bg-gray-50 ${className}`}>
                ...
                <p className="mb-2">
                    Aucun consentement n&apos;a encore été donné pour les cookies.
                </p>
                <p className="text-sm text-gray-600">
                    Veuillez configurer vos préférences via la bannière de cookies.
                </p>
            </div>
        );
    }
                ...
                <ul className="list-disc pl-5 mb-4">
                    ...
                    {consent.marketing && (
                        <li className="mb-1">
                            ...
                            <p className="text-sm text-gray-600">
                                Ces cookies sont utilisés pour suivre les visiteurs sur les sites
                                web et afficher des publicités pertinentes.
                            </p>
                        </li>
                    )}
                </ul>
