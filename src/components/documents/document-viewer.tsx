...
export function DocumentViewer({ 
  ...
  const handlePageClick = (event: React.MouseEvent<HTMLDivElement>) => {
    if (!enableSignature || !currentDocument || currentDocument.status !== DocumentStatus.PENDING) {
      return;
    }
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Button variant="outline" size="sm" onClick={() => downloadDocument(documentId)}>
          ...
          >
            {pdfError ? (
              <div className="flex flex-col items-center justify-center text-center p-6">
                <div className="text-red-500 mb-2">Erreur de chargement du document</div>
                <p className="text-sm text-muted-foreground">
                  Le document n'a pas pu être chargé. Vérifiez que le format est supporté.
                </p>
              </div>
            ) : (
              <PDFDocument
        ...
        {enableWorkflow && (
          <div className="lg:w-1/3 xl:w-1/4">
            <div className="border rounded-md p-4 h-full">
              ...
              {currentDocument.signatories && currentDocument.signatories.length > 0 && (
