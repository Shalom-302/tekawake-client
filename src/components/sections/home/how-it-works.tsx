...
const steps = [
  {
    ...
    description: 'Use our intuitive visual interface to design your API endpoints, define data models, and specify validation rules.',
    icon: (
  ...
  },
  {
    number: '02',
    title: 'Develop & Test',
    description: 'Write your API implementation, with automatic testing and documentation generated from your design.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    number: '03',
    title: 'Deploy & Scale',
    description: 'Deploy your API with one click to our global infrastructure, with automatic scaling based on traffic.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    description: 'Track API performance, user behavior, and business metrics to continuously improve your services.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
