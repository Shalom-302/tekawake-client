...
type StoreButtonVariants = VariantProps<typeof storeButtonVariants>;
type StoreType = "google-play" | "google-play-white" | "app-store" | "galaxy-store" | "app-gallery";
type SizeType = "md" | "lg";
...
export const StoreBadge = ({
    ...
    size?: SizeType;
    store: StoreType;
    variant: Exclude<StoreButtonVariants["variant"], null | undefined>;
    className: string;
}) => {
    ...
    return (
        <Link
            ...
            href={href}
            className={cn(storeButtonVariants({ variant }), className)}
            {...props}
        >
            {renderSVG()}
        </Link>
